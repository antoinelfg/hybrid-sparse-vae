#!/bin/bash
# =============================================================================
#  Overnight Hyperparameter Sweep — Hybrid Sparse VAE
#  
#  Explores β_γ, β_δ, k₀ systematically over 2000 epochs.
#  Each run takes ~10 min on GPU → total ~3h for 18 configs.
#
#  Results saved to: results/<run_name>/train.log
# =============================================================================
...
run_config() {
    ...
    # Run training, capture output, override Hydra output dir
    python train.py \
...
#  β_δ=0.1 fixed, k₀=0.5 fixed, 2000 epochs
# =============================================================================
...
#  β_γ=0.01 fixed (best so far), β_δ=0.1, 2000 epochs
# =============================================================================
...
#  β_γ=0.01 fixed, k₀=0.5, 2000 epochs
# =============================================================================
...
# =============================================================================
#  SWEEP 4: "Sweet spot" combos (best β_γ × best k₀)
# =============================================================================
...
#  More/less sparsity in the prior itself
# =============================================================================
...
# Quick summary: extract last epoch from each run
echo ""
